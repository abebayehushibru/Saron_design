  ...
  return (
    <>
        <div className="contactContainer"  data-aos="fade-up">
          ...
          <div className="formheader"><span><h5 style={{textAlign:"center"}}>Contact Us</h5>
        <h1>
          <span style={{ color: "orange" }}>— </span> Ask us anything.
        </h1></span><button onClick={SetTo}>
...
msg
              ...
              <button type="submit" className="not-shaded" style={{visibility:visibility}}> Send message</button>
            </div>
          </form>
        </div>
